...
import { getMessages, getUsersForSidebar, sendMessage, sendMessageToGroup, getGroupMessages } from "../controllers/message.controller.js";
...
router.post("/send/group/:groupId", protectRoute, sendMessageToGroup);
